...
namespace RamjetAnvil.Volo.CourseEditing
{
    public class CourseEditorActions {
        ...
        private readonly ISubject<Unity.Utility.Tuple<PropId, ImmutableTransform>> _updateProp;
        ...
        public CourseEditorActions() {
            ...
            _updateProp = new Subject<Unity.Utility.Tuple<PropId, ImmutableTransform>>();
        ...
        public ISubject<Unity.Utility.Tuple<PropId, ImmutableTransform>> UpdateProp {
